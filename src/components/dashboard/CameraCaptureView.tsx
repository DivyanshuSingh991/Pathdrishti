    ...
    <div className={`relative overflow-hidden rounded-lg bg-black group select-none ${className}`}>
      ...
      {showAiBoxes && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute border-2 border-cyan-400 bg-cyan-400/25 shadow-[0_0_8px_rgba(6,182,212,0.8)]"
            style={{
          ...
          >
            <div className="absolute -bottom-4.5 left-0 px-1 py-0.5 text-[8px] font-mono font-extrabold text-black bg-cyan-400 rounded-b whitespace-nowrap shadow">
